...
export function V7ShipmentCard({ shipment,allSelected, selectedShipmentId}: {shipment:any, allSelected:boolean, selectedShipmentId:any}) {
  ...
  return (
              ...
              <div className="flex items-center gap-1 text-gry">
                <span className="text-base ">
                  ...
                  <span className="font-medium ml-2">
                    {shipment?.orderId || "غير متوفر"}
                  </span>
              </div>
                {/* </RadioGroup> */}
              {/* Source */}
              <div className="flex items-center gap-3">
                <span className="text-base text-gry">
                المصدر:
                  </span>
   ...
   {/* Status */}
              <div className="flex items-center gap-3   max-w-44 ">
                <div className={`w-full flex items-center  gap-x-2 px-4 py-2 rounded-full border ${getStatusColor()} justify-center`}
                >
          ...
          <div className="flex flex-col  items-center    gap-4">
              ...
              {labelUrl ? (
                ...
                >
                  ...
                  <span className=" text-gry">{moment(shipment?.createdAt).locale('en-sa').format('DD/MM/YYYY')}</span>
              </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className=" v7-neu-card space-y-2 p-4 border border-gray-100 rounded-xl ">
                ...
                {[
                  [
                    "الاسم",
                    `${shipment.customerId?.firstName ?? ""} ${
                      shipment.customerId?.lastName ?? ""
                    }`.trim(),
                  ],
