...
export const store = configureStore({
  reducer: {
    ...
    [createReturnOrExchangeRequestApi.reducerPath]: createReturnOrExchangeRequestApi.reducer,
    [getReturnOrExchangeShipmentsApi.reducerPath]: getReturnOrExchangeShipmentsApi.reducer,
